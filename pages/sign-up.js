        ...
        <form className="mt-6" onSubmit={handleSubmit}>
          <div className="relative flex flex-col mb-6">
            <input
              ...
              className=" bg-semiDarkBlue text-white p-3 outline-none border-b-grayishBlue border-t-0 border-l-0 border-r-0 focus:outline-none focus:ring-0 focus:border-b-grayishBlue placeholder:text-[15px] "
              value={form.email}
